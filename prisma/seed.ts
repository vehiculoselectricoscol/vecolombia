...
async function main() {
  ...
  const vehiclesData = [
    ...
    },
    {
      ...
      description: "Crossover eléctrico americano con conector estándar CCS1 y amplio espacio interior.",
    },
    {
      id: "veh-bmw-i3",
      brand: "BMW",
      ...
      description: "Compacto premium con chasis de fibra de carbono y conector rápido CCS1.",
    },
  ];
  ...
  const stationsData = [
    {
      ...
      connectors: [
        { type: "CCS1", powerKw: 60, count: 2, pricePerKwh: 1750, isAvailable: true },
